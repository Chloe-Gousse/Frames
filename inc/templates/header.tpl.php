...
<body>
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-md navbar-light">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav ">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php?page=category&catName=A venir">A venir</a>
          </li>
        </ul>
      </div>
    </nav>
    <section class="text-center">
      ...
      <p>
        Un blog collaboratif d'artistes qui nous parlent des coulisses de productions d'animation.
      </p>
    </section>
  </header>